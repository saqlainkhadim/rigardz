<nav class="sticky shadow-sm px-6 py-6 flex justify-between items-center bg-white custom-menu">
    ...
    <ul
        ...
        <div @click.away="open = false" class="relative" x-data="{ open: false }">
            <a @click="open = !open" class="text-sm font-bold text-dark" style="cursor: pointer;">
        ...
        <nav
            ...
            <div>
                <ul>
                    ...
                    <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        <a @click="open = !open" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-{{ $config[11]->config_value }}-50 hover:text-{{ $config[11]->config_value }}-600 rounded" style="cursor: pointer;">
                          <span>{{ __('Web Tools') }}</span>
