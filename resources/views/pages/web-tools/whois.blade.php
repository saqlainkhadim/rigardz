            ...
            <div class='flex flex-wrap lg:w-full sm:mx-auto sm:mb-2 lg:mt-12'>  
                <div class="rounded-xl border p-5 shadow-md w-full bg-white">
                    ...
                    <div class="mt-4 mb-2">
                        ...
                        <div class="text-sm text-neutral-600"><img width="20" height="20" src="https://icons.duckduckgo.com/ip3/{{ $results->domainName }}.ico" alt="{{ $results->domainName }}">{{ $results->domainName }}</div>
                    </div>

                    {{-- Registrar Name --}}
                    <div class="mt-4 mb-2">
                        <div class="mb-3 text-xl font-bold">{{ __('Registrar Name') }}</div>
                        <div class="text-sm text-neutral-600">{{ __($results->registrar) }}</div>
                    </div>
                    ...
                    <div class="mt-4 mb-2">
                        ...
                        <div class="text-sm text-neutral-600">{{ __($results->owner) }}</div>
                    </div>
                    @endif
                    ...
                    <div class="mt-4 mb-2">
                        ...
                        <div class="text-sm text-neutral-600">{{ __(':date at :time (UTC :offset)', ['date' =>
