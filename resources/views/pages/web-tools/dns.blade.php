                    ...
                    <div class="rounded-xl border p-5 shadow-md w-full bg-white">
                        ...
                        @else
                            ...
                            <div class="mt-4 mb-2">
                                ...
                                <div class="text-sm text-neutral-600">{{ __('Type') }} : {{ $result['type'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Hostname') }} : {{ $result['host'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('IP') }} : {{ $result['ip'] }}</div>
                                <div class="text-sm text-neutral-600 mb-3">{{ __('TTL') }} : {{ $result['ttl'] }}</div>
                                @endif
                                @endforeach
                            </div>
                            ...
                            <div class="mt-4 mb-2">
                                ...
                                <div class="text-sm text-neutral-600">{{ __('Type') }} : {{ $result['type'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Hostname') }} : {{ $result['host'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('IPv6') }} : {{ $result['ipv6'] }}</div>
                                <div class="text-sm text-neutral-600 mb-3">{{ __('TTL') }} : {{ $result['ttl'] }}</div>
                                @endif
                                @endforeach
                            </div>
                            ...
                            <div class="mt-4 mb-2">
                                ...
                                <div class="text-sm text-neutral-600">{{ __('Type') }} : {{ $result['type'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Hostname') }} : {{ $result['host'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Target') }} : {{ $result['target'] }}</div>
                                <div class="text-sm text-neutral-600 mb-3">{{ __('TTL') }} : {{ $result['ttl'] }}</div>
                                @endif
                                @endforeach
                            </div>
                            ...
                            <div class="mt-4 mb-2">
                                ...
                                <div class="text-sm text-neutral-600">{{ __('Hostname') }} : {{ $result['host'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Target') }} : {{ $result['target'] }}</div>
                                <div class="text-sm text-neutral-600">{{ __('Priority') }} : {{ $result['pri'] }}</div>
                                <div class="text-sm text-neutral-600 mb-3">{{ __('TTL') }} : {{ $result['ttl'] }}</div>
                                @endif
                                @endforeach
                            </div>
                            ...
                            <div class="mt-4 mb-2">
                                ...
                                <div class="text-sm text-neutral-600 {{ !$loop->first ? 'mt-1' : '' }}">{{ __('Entries') }} : {{ $entry }}</div>
                                @endforeach
                                <div class="text-sm text-neutral-600 mb-3">{{ __('TTL') }} : {{ $result['ttl'] }}</div>
                                @endif
                                @endforeach
